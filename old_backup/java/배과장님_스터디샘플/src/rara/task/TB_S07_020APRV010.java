...
public class TB_S07_020APRV010 {
	...
	public static void main(String[] args) throws SQLException {
		...
		List<HashMap<String, Object>> result = sourceClient.queryForList("TB_S07_020APRV010.findAll");
		...
		for(HashMap<String, Object> row : result){
			targetClient.insert("TB_S07_020APRV010.create", row);
