...
public class BetterPopupWindow {
	...
	public void showLikePopDownMenu(int xOffset, int yOffset) {
		...
		this.window.setAnimationStyle(R.style.Animation_PopDownMenu);
	...
	public void showLikeQuickAction(int xOffset, int yOffset) {
		...
		//this.window.setAnimationStyle(R.style.Animation_GrowFromBottom);
		this.window.setAnimationStyle(-1);
		...
		if(rootHeight > anchorRect.top) {
			...
			//this.window.setAnimationStyle(R.style.Animation_GrowFromTop);
			this.window.setAnimationStyle(-1);
		}
