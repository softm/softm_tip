...
if ( function_exists('head') ) {
    if ( $branch == 'setup' && preg_match("/${HTTP_HOST}/",$HTTP_REFERER) ) {
...
?>
    <textarea name="header" style='width:0px;height:0px;display:none'><?=_htmlspecialchars ( f_readFile($baseDir . "data/html/_dboard_header_" . $row['bbs_id'] . ".php"), ENT_QUOTES)?></textarea>
    <textarea name="footer" style='width:0px;height:0px;display:none'><?=_htmlspecialchars ( f_readFile($baseDir . "data/html/_dboard_footer_" . $row['bbs_id'] . ".php"), ENT_QUOTES)?></textarea>
    <textarea name="include_php" style='width:0px;height:0px;display:none'><?=_htmlspecialchars ( f_readFile("files/" . $row['bbs_id'] . ".php"), ENT_QUOTES)?></textarea>
...
<?
            ...
            echo "<textarea name='include_php' cols='91' rows='12'>". _htmlspecialchars ( $file1_str, ENT_QUOTES ) . "</textarea>";
?>
                            </td>
                        </tr>
    </form>
