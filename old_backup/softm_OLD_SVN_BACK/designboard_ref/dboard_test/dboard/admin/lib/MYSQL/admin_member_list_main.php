...
if ( $sort == 'name' || $sort == 'user_id' || $sort == 'reg_date' || $sort == 'acc_date' || $sort == 'point' ) {
    if ( $desc == 'desc' ) {
...
?>
                                <tr title='<?=$member?>'>
                                  ...
                                  <td bgcolor="F7F7F7" class="text_03" align="left" style="padding-left:10px">
                                    <b><a href='#' onClick="window.open ('member_view.php?user_id=<?=base64_encode($row['user_id'])?>', '_dboard_m_view','width=537,height=575,toolbar=no,scrollbars=yes');return false;"><?=$name?></a></b>
                                  </td>
                                  <td bgcolor="F7F7F7" class="text_03" align="left" style="padding-left:5px"><b><?=$user_id?></b></td>
                                  ...
                                  <td bgcolor="F7F7F7" class="text_01" align="center"><?=($acc_year?$acc_year . "." . $acc_month . "." . $acc_day . " " . $acc_hour . ":" . $acc_min . ":" . $acc_sec:"-")?></td>
