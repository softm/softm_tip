...
?>
    ...
    <!--
        function getDisplayList() {
            ...
            var dispListSec      = ( isChecked ( document.boardAbstractForm.disp_list_sec            ) ) ? '1' : '0';   // 비밀글표시

            var display_list     = dispListNo 
                                 + dispListName 
                                 + dispListTitle 
                                 + dispListFile 
                                 + dispListHit 
        ...
        function updateData () {
            ...
            document.boardAbstractForm.display_list.value = getDisplayList();
    ...
    //      document.boardAbstractForm.footer.value = footerDocument.body.innerHTML;
        ...
        function abstractSource() {
            ...
            var display_list     = getDisplayList();
...
<BR/>&nbsp;
<?
    $checked = ( $displayList[9] ) ? "checked  onClick='abstractSource();' " : " onClick='abstractSource();' "; // 당일의견글
    echo "<input type='checkbox' name='disp_list_sec'    value='1' $checked> 비밀글 <img src='/dboard/skin/board/dboard_2_0/images/icon_sec.gif'/>";
...
?>
    <textarea name="header" style='display:none'><?=_htmlspecialchars ( f_readFile($baseDir . "data/html/_dnotice_header_" . $row['bbs_id'] . ".php"), ENT_QUOTES)?></textarea>
    <textarea name="footer" style='display:none'><?=_htmlspecialchars ( f_readFile($baseDir . "data/html/_dnotice_footer_" . $row['bbs_id'] . ".php"), ENT_QUOTES)?></textarea>
                          </td>
                        </tr>
