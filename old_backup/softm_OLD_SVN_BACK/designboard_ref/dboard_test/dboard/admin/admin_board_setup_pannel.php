...
if ( $memInfor['admin_yn'] == "Y" ) {
    ...
    //      if($file1 && file_exists($file1) && ( $file_ext == 'txt' || $file_ext == 'html' || $file_ext == 'htm' ) ) {
            ...
            echo "<form name='setupForm'><textarea name='header' cols='90' rows='12'>". _htmlspecialchars ( $file1_str, ENT_QUOTES ). "</textarea></form>";
    ...
    if($gubun == 'footer' ) {
        if ( $_FILES['footer_file'] ) {
            ...
            echo "<form name='setupForm'><textarea name='footer' cols='90' rows='12'>". _htmlspecialchars ( $file1_str, ENT_QUOTES ) . "</textarea></form>";
