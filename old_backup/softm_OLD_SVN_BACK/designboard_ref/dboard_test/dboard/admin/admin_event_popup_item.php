...
<!--
    ...
    function viewDetail(gNo) {
        ...
        var preinsertitemObj = document.getElementById( '_dboard_detail_' + preGno );
        if ( preinsertitemObj && gNo != preGno ) {
            console.info(preinsertitemObj);
            preinsertitemObj.style.position   = 'absolute';
            preinsertitemObj.style.visibility = 'hidden'  ;
            preinsertitemObj.style.zIndex     = -1        ;
        }
        var obj = document.getElementById('_dboard_detail_' + gNo);
...
<form name='eventItemInsertForm'  action='<?=$libDir?>admin_event_popup_item_exec.php' onSubmit='return mainInsert();'>
    ...
    <input type='hidden' name='g_no'  value=''>
              <tr>
                <td height="1" colspan="10" align="right" background="<?=$baseDir?>images/bg2.gif" class="bg_line2" bgcolor="fafafa" class="text_01"></td>
              </tr>
              <tr bgcolor="eeeeee">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="5">
              <tr> 
                <td height="1" colspan="10" align="center" background="<?=$baseDir?>images/bg2.gif" class="bg_line2" bgcolor="fafafa" class="text_01"></td>
              </tr>
              <tr> 
              ...
              <tr> 
                <td height="1" colspan="10" align="right" bgcolor="fafafa" class="text_01 bg_line2" background="<?=$baseDir?>images/bg2.gif"></td>
              </tr>
