...
if ( function_exists('head') ) {
    if ( $branch == 'setup' && preg_match("/${HTTP_HOST}/",$HTTP_REFERER) && preg_match( "(admin_event.php)", $HTTP_REFERER) && $REQUEST_METHOD == 'POST' ) {
...
?>
    ...
    */
    ...
    ?>
        <textarea name="header" style='display:none'><?=_htmlspecialchars ( f_readFile("data/event/$event_id/_dboard_event.php"), ENT_QUOTES)?></textarea>
                           </td>
                        </tr>
