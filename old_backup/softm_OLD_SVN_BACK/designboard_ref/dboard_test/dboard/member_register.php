...
//              window.moveTo(0, y);
        ...
        function dupCheck() {
            ...
            if (  memberIdCheck(userId) ) {
                ...
                var dupWin = window.open('about:blank','dupChkWin','toolbar=no,menubar=no,resizable=no,scrollbars=no,width=315,height=160');
                dupWin.focus();
...
scrollbar-arrow-color: #FFFFFF;margin:0px 0px 0px 0px;overflow-x:hidden }
</style>
</head>
<body onLoad='memberOnLoad();'>
...
?>
    ...
    ?>
                        ...
                        <tr bgcolor="fafafa">
                          <td align="right" height="1" colspan="2" background="<?=$baseDir?>images/bg2.gif" class="bg_line2"></td>
                        </tr>
    <?
    }
    ?>
    ...
    ?>
                        ...
                        <tr>
                          <td bgcolor="#FFFFFF" align="right" height="1" colspan="2" background="<?=$baseDir?>images/bg2.gif" class="bg_line2"></td>
                        </tr>
    <?
    }
    ?>
<img src='<?=$baseDir?>images/timg.gif' id='_dboard_tmp_img' style='position:absolute;visibility:hidden;'>
...
if ( !@is_file($dir . $f1 ) ) {
    ...
    echo "  <img src='". $baseDir. "images/timg.gif' id='_dboard_preview_img1' border='0'>";
    echo "</a>";
...
if ( !@is_file($dir . $f2 ) ) {
    ...
    echo "  <img src='". $baseDir. "images/timg.gif' id='_dboard_preview_img2' border='0'>";
    echo "</a>";
...
<?
    ...
    echo ( "//-->\n");
    echo ( "</SCRIPT>\n");
    Message('P', '0012',"javascript:windowClose();:확인", $skinDir); // 회원 수정 정보가 존재하지 않습니다.
}
footer(); // Footer 출력
?>