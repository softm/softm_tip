...
?>
                    ...
                    <tr bgcolor="fafafa">
                      <td align="right" colspan="2" background="images/bg2.gif" class="bg_line2" height="1"></td>
                    </tr>
<?
    }
?>
...
?>
                    ...
                    <tr bgcolor="fafafa" >
                      <td height="1" colspan="2" align="right"background="images/bg2.gif" class="bg_line2"></td>
                    </tr>
<?
    }
?>
...
?>
                    ...
                    <tr bgcolor="fafafa">
                      <td align="right" height="1" colspan="2" background="images/bg2.gif" class="bg_line2"></td>
                    </tr>
<?
    }
?>
...
<?
    ...
    if ( !$openChk ) {
        Message('P', '0017',"javascript:windowClose();:확인", $skinDir); // 공개된 회원 정보가 없습니다.
    } else {
