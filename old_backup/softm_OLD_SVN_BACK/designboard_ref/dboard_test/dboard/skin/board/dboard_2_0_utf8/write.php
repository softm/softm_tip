...
<?=$hide_file1_s       ?>
    <tr>
      ...
      <td class="text_03">
        ...
        <input type="checkbox" name="file1_delete" id="file1_delete" value="Y"><span id='file1_delete_lable'>삭제</span>
      </td>
    </tr>
<?=$hide_file1_e       ?>
<?=$hide_file2_s       ?>
    <tr>
      ...
      <td class="text_03">
        ...
        <input type="checkbox" name="file2_delete" id="file2_delete" value="Y"><span id='file2_delete_lable'>삭제</span>
      </td>
    </tr>
<?=$hide_file2_e       ?>
<?=$hide_link1_s       ?>
    ...
    <tr>
      <td width="60" align="right"><b>링크1</b></td>
      <td></td>
      <td class="text_04">
        <input type="text" name="link1" class="textarea_01" style="width:50%" value='<?=$link1?>'>
      </td>
    </tr>
<?=$hide_link1_e       ?>
...
<?=$hide_link2_s       ?>
    ...
    <tr>
      <td width="60" align="right"><b>링크2</b></td>
      <td></td>
      <td class="text_04">
        <input type="text" name="link2" class="textarea_01" style="width:50%" value='<?=$link2?>'>
      </td>
    </tr>
<?=$hide_link2_e       ?>
<?=$hide_password_s   ?>
