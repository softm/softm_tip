<!-- <BR>
<BR>
  <table width="" border="0" cellspacing="0" cellpadding="0" class="text_01" align='center'>
    <tr> 
  ...
  <table width="" border="0" cellspacing="0" cellpadding="0" align='center'>
    <tr> 
      ...
      <a href='#' onClick='history.back();'><img border="0" name="imageField62" src="<?=$skinDir?>images/button_back.gif" align="top" border='0'></a>
      </td>
      <td height="40" background="<?=$skinDir?>images/bg_list_bottom.gif">&nbsp;</td>
    </tr>
  </table> -->