...
<?=$hide_reg_date_e?>
	  ...
	  <td height="30" background="<?=$skinDir?>images/bg_list_main.gif" width="40" align="center" class="text_02"><?=$a_single_add_cart?>´ã±â</a></td>
      
	  <td height="30" background="<?=$skinDir?>images/bg_list_main.gif" width="40" align="center" class="text_02"><?=$a_single_del_cart?>»©±â</a></td>
     
	  <td height="30" background="<?=$skinDir?>images/bg_list_main.gif" width="40" align="center" class="text_02"><?=$a_single_play?>µè±â</a></td>
