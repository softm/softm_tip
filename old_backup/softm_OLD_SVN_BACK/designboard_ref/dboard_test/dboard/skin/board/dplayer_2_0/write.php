...
<?=$hide_file1_s       ?>
    <tr>
      <td width="60" align="right"><b>음악</b></td>
      <td></td>
      <td class="text_03">
        <input type="file" name="file1" class="textarea_01" onChange='titleAutoInsert();'>
...
<?=$hide_file2_s       ?>
    <tr>
      <td width="60" align="right"><b>가사</b></td>
      <td></td>
      <td class="text_03">
...
<?=$hide_name_s     ?>
    ...
    <tr>
      <td width="60" align="right"><b>가수명</b></td>
      <td width="10"></td>
      <td class="text_04">
