...
var serviceBase = typeof(SERVICE_BASE)=="undefined"?(baseDir?baseDir+"/service":"service"):SERVICE_BASE;
if ( !document.all  ) {
...
//alert();
        ...
        IframeSubmit.iframe.style.width   = '0px';
        IframeSubmit.iframe.style.height  = '0px';
        if ( document.all ) {
...
function call(requestType,className,method,argus,cb,form) {
    if ( requestType == 'JSON' ) {
...
var ROOT_DIR = "D:/Project/12.03_FrameWork/source";
var SOFTMARGUMENT = {};
