                  ...
                  <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="CCCCCC">
                    <tr bgcolor="#FFFFFF"> 
                      <td colspan="20" height="45" class="text_01" background="images/top_10.gif" align="right"> 
                          <a href='#' onClick='moveSetupPage    (<?=$no?>);return false;'><img border="0" name="imageField4222" src="images/button_poll_01.gif" width="66" height="30" align="middle"></a>
                          <a href='#' onClick='moveAbstractPage (<?=$no?>);return false;'><img border="0" name="imageField42222" src="images/button_poll_03.gif" width="66" height="30" align="middle"></a>
