...
<?
    ...
    $category_setup['script'            ]   = "onChange='categorySearch(this.form);'"  ; // 스크립트
...
<?=$show_admin_yn_s?>
<B><a href="<?=$baseDir?>admin_board.php?branch=setup&gubun=&no=<?=$bbsInfor['no']?>" target='_new'><font face='tahoma' size='1'><img src="<?=$skinDir?>images/button_setup.gif" border=0></font></a></B>
<?=$show_admin_yn_e?><?=$a_login?><img src="<?=$skinDir?>images/button_login2.gif" border=0></a><?=$a_logout?><img src="<?=$skinDir?>images/button_logout.gif" border=0></a> <?=$a_member_register?><img src="<?=$skinDir?>images/button_join2.gif" border=0></a><?=$a_member_update?><img src="<?=$skinDir?>images/button_modify2.gif" border=0></a>
</td>
</tr>
</table>