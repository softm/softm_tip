          ...
          <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="2" bgcolor="#FFFFFF">
              <tr> 
                ...
                <td>
                <input type="text" name="user_id" size="12" class="textarea_01" value='<?=$user_id?>' tabindex=1>
                </td>
              </tr>
              <tr> 
                <td align="right" class="login_text_01">비밀번호</td>
                <td> 
                  <input type="password" name="password" size="12" class="textarea_01"  tabindex=2>
                </td>
              </tr>
              <tr> 
                <td bgcolor="#FFFFFF" align="right" height="10" colspan="2"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="login_text_01">
                    ...
                    <tr> 
                      <td colspan="3" align="right" height="1" background="<?=$loginSkinDir?>images/bg2.gif"></td>
                    </tr>
                    <tr> 
