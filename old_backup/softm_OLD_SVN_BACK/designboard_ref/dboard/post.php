...
head('우편 번호 조회', 'postOnLoad()');          // Header 출력
_css($baseDir);
        ...
        <tr> 
          <td class="text_01"> 
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="5">
              <tr> 
                <td bgcolor="fafafa" background="images/dot1.gif" height="1"></td>
              </tr>
              <tr> 
                <td bgcolor="fafafa"> 
...
if ( $search ) {
    ...
    if ( $cnt > 0 ) {
        ...
        echo "</tr>";
        echo "<tr> ";
        echo "  <td bgcolor='fafafa' background='images/dot1.gif' height='1'></td>";
        echo "</tr>";
    }
}
?>
