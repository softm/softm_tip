...
if ( function_exists('_head') ) {
    if ( $exec == 'view' && $grant == 'Y' && !ereg( "(".$HTTP_SERVER_VARS['HTTP_HOST'].")((.)*(/)+)+(view.php)", $HTTP_SERVER_VARS['HTTP_HOST'] . $HTTP_SERVER_VARS['PHP_SELF'] ) ) {
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////
                ...
                $hit_cotent_stats = ereg('%' . $id . '_' . $no, $hit_cotent_chk );
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //          echo '$displayView[1] : ' . $displayView[1];
                ...
                MessageC ('S', '0030',"", $skinDir); // 게시물 없음
            }
        } else {
            MessageC ('S', '0012',"", $skinDir); // 게시물 없음
        }
