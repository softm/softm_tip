...
//  contentStr = contentStr.replace(/\<\?=\$a_member_view\?>/g ,'<a href="#" onClick=\'openMemberView("' + user_id + '","' + memberViewMode + '","' + memberViewSuccUrl + '","' + memberViewPopupWidth + '","' + memberViewPopupHeight + '","' + memberViewScrollYn + '");return false;\'>');
	contentStr = contentStr.replace(/\<\?=\$a_member_view\?>/g ,"<a href='#' onClick='window.open(\"" + baseDir + 'member_view.php?user_id='+ user_id + '","_dboard_m_view","width=' + member_view_popup_width + ',height=' + member_view_popup_height + ',toolbar=no,scrollbars=' + member_view_scroll_yn + '");return false;\'>');
