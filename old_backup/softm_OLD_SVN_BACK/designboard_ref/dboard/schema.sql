...
/* 게시판 정보 */
    ...
    $tb_bbs_infor_schm .= "    login_skin_name          VARCHAR (40)    NOT NULL            , /* 로그인 스킨 명         */";
    ...
    $tb_bbs_infor_schm .= "    reg_date                 CHAR    (14)    NOT NULL            , /* 게시판 생성 일자       */";
    $tb_bbs_infor_schm .= "    upd_date                 CHAR    (14)    NOT NULL            , /* 게시판 수정 일자       */";
...
/* 게시물 추출 정보 */
    ...
    $tb_bbs_abstract_schm .= "    reg_date         CHAR    (14)    NOT NULL        , /* 생성 일자              */";
...
/* 회원 정보 */
    ...
    $tb_member_schm .= "    jumin                VARCHAR (20)            , /* 주민번호   */";
    ...
    $tb_member_schm .= "    post_no              VARCHAR (7 )    NOT NULL, /* 우편번호   */";
    ...
    $tb_member_schm .= "    reg_date             CHAR    (14)    NOT NULL   , /* 가입 일자   */";
    $tb_member_schm .= "    acc_date             CHAR    (14)    NOT NULL   , /* 최근 접근일 */";
//  $tb_member_schm .= "    primary key (user_id),";
...
/* 회원 종류 */
    ...
    $tb_member_kind_schm .= "    reg_date            CHAR    (14)       NOT NULL    , /* 가입 일자      */";
...
/* 설문 조사 정보 */
    ...
    $tb_poll_master_schm .= "    reg_date               CHAR    (14 )   NOT NULL   , /* 설문 생성 일자     */";
...
/* 게시판 */
    ...
    $tb_bbs_data_schm .= "    reg_date            CHAR    (17)    NOT NULL    , /* 작성 및 변경일자   */";
    ...
    $tb_bbs_data_schm .= "    comment_date        CHAR    (14)    NOT NULL    , /* 의견글 마지막 작성일자 */";
...
/* 게시판 파일 업로드 정보 --> 현재 버전에서는 구성되지 않음 :: 추후. 게시판 파일 관리 버전에 적용됨. */
    ...
    $tb_bbs_file_schm .= "    reg_date            CHAR    (17   )   NOT NULL    , /* 작성 및 변경일자   */";
...
/* 설문 조사 간단 답변 */
    ...
    $tb_poll_comment_schm .= "    reg_date            CHAR    (14)    NOT NULL    , /* 가입 일자      */";
...
/* 게시판 간단 답변 */
    ...
    $tb_bbs_comment_schm .= "    reg_date            CHAR    (14)    NOT NULL    , /* 가입 일자      */";
...
/* 우편 번호 */
    ...
    $tb_post_schm .= "  sido       VARCHAR      (4 )            , /*  특별시,광역시,도  */";
