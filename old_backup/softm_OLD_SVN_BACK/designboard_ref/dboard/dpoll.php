                ...
                if ( ( $compare_date - $sysDate ) < 0 && $admin_yn == 'N' ) {
                    ...
                    if ( $lg != 'Y' && $login_yn == 'N' && $grant == 'N' ) {
                        ...
                        if ( $login_yn == 'Y' && $grant == 'N' ) {
							...
							include $baseDir.'common/js/poll_js.php'; // 설문조사 javascript
							include $baseDir.'common/js/member_infor_js.php'; // 회원 정보 보기 관련
...
// 링크 설정
                            ...
                            if ( $poll_exec == 'poll' ) { // 설문 조사
                                ...
                                include "common/lib/" . $sysInfor["driver"] . '/' . "poll_exec.php"; // 설문 조사 실행
                            }
                                ...
                                include "common/lib/" . $sysInfor["driver"] . '/' . 'write_comment_exec.php'; // 입력 실행
                            }
    ...
    logs ( "\n실행 시간 : " . sprintf("%0.3f",$_sessionEnd - $_sessionStart) . "\n-->", true);
			if ( $self_yn ) _footer ();
                ...
                MessageC ('S', '0041'); // 설문 조사가 존재 하지 않습니다.
            } // else END
        }
