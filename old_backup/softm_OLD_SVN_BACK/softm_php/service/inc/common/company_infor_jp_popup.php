...
<body>
    <a href=# onclick="UI.openWindow('/service/inc/common/company_infor_jp_popup.php', 750, '768','w_company_infor_jp',{scrollbars:'yes'}).focus();">팝업</a>
<?
require(SERVICE_DIR . "/inc/common/company_infor_jp.inc"); // 기업정보조회폼.
?>
