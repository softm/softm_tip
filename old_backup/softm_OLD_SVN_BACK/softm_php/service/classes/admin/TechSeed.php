...
class TechSeed extends BaseDataBase
{
    ...
    public function __construct() {
        ...
        if ( METHOD == "select" || METHOD == "save"  ) {
    		...
    		$tbl1->newColumn('ORGAN'   ,'기관명',3)->setWidth(300)->setEditable(false)->setCssText("text-align:left");    		
    		$tbl1->newColumn('TECH_NM' ,'기술명',4)->setEditable(false)->setCssText("text-align:left");
	        $tbl1->newColumn('REG_DATE','등록일',5)->setWidth(100)->setKey(false);    		
        }
    }
