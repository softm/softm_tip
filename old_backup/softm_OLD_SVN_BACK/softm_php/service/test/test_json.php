...
$arr['item'] = array();
$arr['item'][] = array(
	"no"=>array("value"=>"1","isnull"=>"0"),
	"member_level"=>array("value"=>"1","isnull"=>"0"),
	"name"=>array("value"=>"관리자","isnull"=>"0")
);
$arr['item'][] = array(
	"no"=>array("value"=>"1","isnull"=>"0"),
	"member_level"=>array("value"=>"1","isnull"=>"0"),
...
// 			var_dump($this);echo "<BR>";echo "<BR>";
				...
				$this->{$keyp} = $jel;
// 				var_dump($this);echo "<BR>";echo "<BR>";
// 				echo "<BR>";echo "<BR>";var_dump($this);echo "<BR>";echo "<BR>";
			}
		} else {
...
// $results->a = "a";
// appendNode('start_date',date('Y/m/d h:i:s A'));
// // $data->results->appendNode('item',"zz");
// // var_dump($data);
// // var_dump($dom);
// createNode('item');
echo "<BR>";
