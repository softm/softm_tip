function onInit(argus) {
    ...
    GRID.init({
        ...
        service_infor:{
            className  : "front.BbsDataNotice",
            method     : { "list":"front.BbsDataNotice.select", "save":"save" },
            argus      : {
                p_navi_function:"조회"
            }
        },
        onload:function(o) { // o.mode : I/U/D/M/R/SORT
            ...
            if ( o.data.return == "200" ) {
                if ( o.mode == "U" || o.mode == "D" ) {
                    ...
                    document.location.href= "/bbs.php";
                }
            }
            onLoad(o,argus);
        }
...
function onLoad(o,argus) { // o.mode : I/U/D/M/R/SORT
    $('tbody td.col4').each(function(index, element){
        ...
        $(td).html("<a href='/bbs.php?mode=view&p_no=" + no + "'><u>"+$(td).text()+"</u></a>");
    });
}
