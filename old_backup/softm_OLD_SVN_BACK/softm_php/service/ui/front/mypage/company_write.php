...
?>
  ...
  <tr>
    ...
    <td><input type="text" name="capital" style="width:100px;text-align:right" maxlength=10/>
      백만원</td>
  </tr>
  <tr>
    <td colspan="2" id="t1">매출액</td>
    <td><input type="text" name="sales" style="width:100px;text-align:right" maxlength=10/>
백만원</td>
  </tr>
  <tr>
    <td colspan="2" id="t1">예상매출액</td>
    <td><input type="text" name="expect_sales" style="width:100px;text-align:right" maxlength=10/>
백만원</td>
  </tr>
  <tr>
    <td colspan="2" id="t1">경상이익</td>
    <td><input type="text" name="ordinary_income" style="width:100px;text-align:right" maxlength=10/>
백만원</td>
  </tr>
  <tr>
...
?>
<input type=submit style='vertical-align:middle' value="기업회원가입"/>
<?php 
} else {
?>
