...
<input type='hidden' name='user_no' size=10 value=''/>
				...
				<div class="view_tb01">
					<table cellpadding="0" cellspacing="0" summary="">
						...
						<tr>
							...
							<td><input type='text' name='name' size=40 value='<?=USER_NAME?>' style='width:100px' class='required trim focus alert' maxlength=40 minlength=0 message='이름를 입력해주세요.' /></td>
						</tr>
						<tr>
							<th scope="row"><label for="n_sub">제목</label></th>
							<td><input type='text' name='title' size=255 value='' style='width:637px' class='required trim focus alert' maxlength=255 minlength=0 message='제목를 입력해주세요.' /></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2">
								<textarea rows="" cols="" name='content' value='' class='required trim focus alert' message='내용를 입력해주세요.'></textarea>
							</td>
						</tr>
						<tr>
							<th scope="row">파일</th>
				...
				<div class="btn_area_n clear">
					...
					<a href="#" title="삭제하기" onclick="return 삭제();">삭제</a>
				</div>
</form>