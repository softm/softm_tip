...
$creategory_setup['loop_end_tag'    ] = ""  ;
$creategory_setup['append_tag'      ] = "<input type='radio' name='s_hope_biz_type' value='' onchange='fGetList(1)' checked>전체";
...
<table cellspacing="0" cellpadding="0" width="98%" border="0" align='center'>
  <tr>
    <td align="right">
    <a href='#' onclick="return 입력();">
      <image src=/images/config/button_add.gif border=0 align=absmiddle>
    </a>
    </td>
  </tr>
  <tr height="35">
