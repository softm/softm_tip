...
대공종코드명 : <input type='text' name='proc_nm' size=255 value='' style='width:637px' class='required trim focus alert' maxlength=255 minlength=0 message='대공종코드명를 입력해주세요.' /><BR>
</form>