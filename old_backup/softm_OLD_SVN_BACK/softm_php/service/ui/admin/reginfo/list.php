...
<select name="p_proc_it_cd" id="p_proc_it_cd" class='required trim focus alert' message='공정항목을 선택해주세요.' style="width:150px">
    <option value="">공종항목</option>
    <option value="">공종항목</option>
    <option value="">가설전기</option>
</select>
<select name="p_proc_bd_cd" id="p_proc_bd_cd" class='required trim focus alert' message='공정항목내역을 선택해주세요.' style="width:200px">
    ...
    <option value="">잡석깔기 </option>
					...
					<!-- <input type="text" name="proc_bd_nm" id="proc_bd_nm"  class='required trim focus alert' maxlength=255 minlength=0 message='공종항목명을 입력해주세요.' style="width:200px"/>
...
$creategory_setup['prop_name'       ] = 'p_state';
$creategory_setup['title'           ] = '-상태-'  ;
$creategory_setup['script'          ] = ""  ;
$creategory_setup['properties'      ] = " name='p_state' id='p_state' class='required trim focus alert' message='상태를 선택해주세요.' style='width:100px'"  ;
$creategory_setup['loop_end_tag'    ] = ""  ;
$creategory_setup['append_tag'      ] = "";
$selectInfo = Base::$CODE_STATE_REGINFO;
...
<div class="list_search clear" style="border:0px;text-align:right">
      <a href=# onclick="return 입력();">입력</a>
</div>
