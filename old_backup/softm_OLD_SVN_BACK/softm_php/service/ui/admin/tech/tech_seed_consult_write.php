...
<table border="0" cellpadding="0" cellspacing="0" id="admin" width="100%">
    ...
    <tr>
      <td width="210"  id="t1" colspan="2" >기술코드</td>
      <td><input type="text" name="tech_reg_code" id="tech_reg_code" style="width:530px;border:0px" readonly></td>
    </tr>
    <tr >
      <td  colspan="2" id="t1" >사업코드</td>
      <td>
        <input type="text" name="reg_code" id="reg_code" style="width:530px;border:0px" readonly/></td>
    </tr>
        <tr>
...
<span class="p14 b bl06">2. 공급가능한 기술</span><br/><br/>
