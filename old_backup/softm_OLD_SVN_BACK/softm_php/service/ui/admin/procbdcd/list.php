				<p class="list_tit">대중소관리 - 공종항목내역</p>
...
<select name="p_proc_it_cd" id="p_proc_it_cd" class='required trim focus alert' message='공정항목을 선택해주세요.' style="width:200px">
    ...
    <option value="">가설전기</option>
					...
					<input type="text" name="proc_bd_nm" id="proc_bd_nm"  class='required trim focus alert' maxlength=255 minlength=0 message='공종항목명을 입력해주세요.'/>
