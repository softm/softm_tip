function onInit(argus) {
    ...
    GRID.init({
        ...
        service_infor:{
            className  : "test.calkoheader.CalkoHeader",
            method     : { "list":"test.calkoheader.CalkoHeader.select", "save":"save" },
            argus      : {
                p_navi_function:"조회"
            }
        },
...
function 파일다운로드() {
	call("FORM","common.Common","saveDownload", 
		{
		p_file_nm:"Characteristic - Header.xls",
		p_data:
		"<table>" +
