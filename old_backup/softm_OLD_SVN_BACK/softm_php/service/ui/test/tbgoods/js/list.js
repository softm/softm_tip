function onInit(argus) {
    ...
    GRID.init({
        ...
        service_infor:{
            className  : "test.tbgoods.TbGoods",
            method     : { "list":"test.tbgoods.TbGoods.select", "save":"save" },
            argus      : {
                p_navi_function:"조회"
            }
        },
...
//        	onclick:function(o) {
//        		//        		console.debug(o);
//        		getUI("test/tbgoods","write",{
//        			method:"POST",
//        			argus : {
//        				p_gid:GRID.getValue(o.tId,o.tr.rowIndex,"gid")
...
function onLoad(o,argus) { // o.mode : I/U/D/M/R/SORT
    ...
    $(".btn_modify").click(function(e) {
        ...
        getUI("test/tbgoods","write",{
            method:"POST",
            argus : {
              p_gid:GRID.getValue($S("tbl_list"),tr.rowIndex,"gid")
