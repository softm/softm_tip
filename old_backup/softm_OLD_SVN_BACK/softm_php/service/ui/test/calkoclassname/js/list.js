function onInit(argus) {
    ...
    GRID.init({
        ...
        service_infor:{
            className  : "test.calkoclassname.CalkoClassName",
            method     : { "list":"test.calkoclassname.CalkoClassName.select", "save":"save" },
            argus      : {
                p_navi_function:"조회"
            }
        },
...
//        	onclick:function(o) {
//        		//        		console.debug(o);
//        		getUI("test/calkoclassname","write",{
//        			method:"POST",
//        			argus : {
//        				p_class_name:GRID.getValue(o.tId,o.tr.rowIndex,"class_name")
...
function onLoad(o,argus) { // o.mode : I/U/D/M/R/SORT
    $(".btn_modify").click(function(e) {
        ...
        getUI("test/calkoclassname","write",{
            method:"POST",
            argus : {
              p_class_name:GRID.getValue($S("tbl_list"),tr.rowIndex,"class_name")
...
function 파일다운로드() {
	call("FORM","common.Common","saveDownload", 
		{
		p_file_nm:"calko class name.xls",
		p_data:
		"<table>" +
