function onInit(argus) {
    ...
    GRID.init({
        ...
        service_infor:{
            className  : "test.post.Post",
            method     : { "list":"test.post.Post.select", "save":"save" },
            argus      : {
                p_navi_function:"조회"
            }
        },
...
//        	onclick:function(o) {
//        		//        		console.debug(o);
//        		getUI("test/post","write",{
//        			method:"POST",
//        			argus : {
//        				p_post_seq:GRID.getValue(o.tId,o.tr.rowIndex,"post_seq")
...
function onLoad(o,argus) { // o.mode : I/U/D/M/R/SORT
    $(".btn_modify").click(function(e) {
        ...
        getUI("test/post","write",{
            method:"POST",
            argus : {
              p_post_seq:GRID.getValue($S("tbl_list"),tr.rowIndex,"post_seq")
