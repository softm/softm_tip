function onInit(argus) {
    ...
    GRID.init({
        ...
        service_infor:{
            className  : "test.eunjustudymaster.EunJuStudyMaster",
            method     : { "list":"test.eunjustudymaster.EunJuStudyMaster.select", "save":"save" },
            argus      : {
                p_navi_function:"조회"
            }
        },
...
//        	onclick:function(o) {
//        		//        		console.debug(o);
//        		getUI("test/eunjustudymaster","write",{
//        			method:"POST",
//        			argus : {
//        				p_s_id:GRID.getValue(o.tId,o.tr.rowIndex,"s_id")
...
function onLoad(o,argus) { // o.mode : I/U/D/M/R/SORT
    $(".btn_modify").click(function(e) {
        ...
        getUI("test/eunjustudymaster","write",{
            method:"POST",
            argus : {
              p_s_id:GRID.getValue($S("tbl_list"),tr.rowIndex,"s_id")
