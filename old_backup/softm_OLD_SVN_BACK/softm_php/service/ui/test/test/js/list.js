function onInit(argus) {
    ...
    GRID.init({
        ...
        service_infor:{
            ...
            method     : { "list":"test.test.Test.select", "save":"save" },
            argus      : {
                p_navi_function:"조회"
            }
        },
...
//        	onclick:function(o) {
//        		//        		console.debug(o);
//        		getUI("test/test","write",{
//        			method:"POST",
//        			argus : {
//        				p_k1:GRID.getValue(o.tId,o.tr.rowIndex,"k1")
...
function onLoad(o,argus) { // o.mode : I/U/D/M/R/SORT
    $(".btn_modify").click(function(e) {
        ...
        getUI("test/test","write",{
            method:"POST",
            argus : {
              p_k1:GRID.getValue($S("tbl_list"),tr.rowIndex,"k1")
