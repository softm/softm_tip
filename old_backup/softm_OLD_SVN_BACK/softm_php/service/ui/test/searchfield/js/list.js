function onInit(argus) {
    ...
    GRID.init({
        ...
        service_infor:{
            className  : "test.searchfield.SearchField",
            method     : { "list":"test.searchfield.SearchField.select", "save":"save" },
            argus      : {
                p_navi_function:"조회"
            }
        },
...
//        	onclick:function(o) {
//        		//        		console.debug(o);
//        		getUI("test/searchfield","write",{
//        			method:"POST",
//        			argus : {
//        				p_sf_no:GRID.getValue(o.tId,o.tr.rowIndex,"sf_no")
...
function onLoad(o,argus) { // o.mode : I/U/D/M/R/SORT
    ...
    $(".btn_modify").click(function(e) {
        ...
        getUI("test/searchfield","write",{
            method:"POST",
            argus : {
              p_sf_no:GRID.getValue($S("tbl_list"),tr.rowIndex,"sf_no")
