function onInit(argus) {
    ...
    GRID.init({
        ...
        service_infor:{
            className  : "test.hdarea01.HdArea01",
            method     : { "list":"test.hdarea01.HdArea01.select", "save":"save" },
            argus      : {
                p_navi_function:"조회"
            }
        },
...
//        	onclick:function(o) {
//        		//        		console.debug(o);
//        		getUI("test/hdarea01","write",{
//        			method:"POST",
//        			argus : {
//        				p_cap_cd:GRID.getValue(o.tId,o.tr.rowIndex,"cap_cd")
...
function onLoad(o,argus) { // o.mode : I/U/D/M/R/SORT
    $(".btn_modify").click(function(e) {
        ...
        getUI("test/hdarea01","write",{
            method:"POST",
            argus : {
              p_cap_cd:GRID.getValue($S("tbl_list"),tr.rowIndex,"cap_cd")
...
function 파일다운로드() {
	call("FORM","common.Common","saveDownload", 
		{
		p_file_nm:"InnoDB free: 3945472 kB.xls",
		p_data:
		"<table>" +
