function onInit(argus) {
    ...
    GRID.init({
        ...
        service_infor:{
            className  : "test.accountingexchangerate.AccountingExchangeRate",
            method     : { "list":"test.accountingexchangerate.AccountingExchangeRate.select", "save":"save" },
            argus      : {
                p_navi_function:"조회"
            }
        },
...
//        	onclick:function(o) {
//        		//        		console.debug(o);
//        		getUI("test/accountingexchangerate","write",{
//        			method:"POST",
//        			argus : {
//        				p_accounting_no:GRID.getValue(o.tId,o.tr.rowIndex,"accounting_no")
...
function onLoad(o,argus) { // o.mode : I/U/D/M/R/SORT
    $(".btn_modify").click(function(e) {
        ...
        getUI("test/accountingexchangerate","write",{
            method:"POST",
            argus : {
              p_accounting_no:GRID.getValue($S("tbl_list"),tr.rowIndex,"accounting_no")
