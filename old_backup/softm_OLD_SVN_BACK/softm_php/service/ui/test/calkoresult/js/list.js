function onInit(argus) {
    ...
    GRID.init({
        ...
        service_infor:{
            className  : "test.calkoresult.CalkoResult",
            method     : { "list":"test.calkoresult.CalkoResult.select", "save":"save" },
            argus      : {
                p_navi_function:"조회"
            }
        },
...
//        	onclick:function(o) {
//        		//        		console.debug(o);
//        		getUI("test/calkoresult","write",{
//        			method:"POST",
//        			argus : {
//        				p_esti_no:GRID.getValue(o.tId,o.tr.rowIndex,"esti_no"),
//        				p_seq:GRID.getValue(o.tId,o.tr.rowIndex,"seq")
...
function onLoad(o,argus) { // o.mode : I/U/D/M/R/SORT
    $(".btn_modify").click(function(e) {
        ...
        getUI("test/calkoresult","write",{
            method:"POST",
            argus : {
              p_esti_no:GRID.getValue($S("tbl_list"),tr.rowIndex,"esti_no"),
              p_seq:GRID.getValue($S("tbl_list"),tr.rowIndex,"seq")
...
function 파일다운로드() {
	call("FORM","common.Common","saveDownload", 
		{
		p_file_nm:"Characteristic - Detail.xls",
		p_data:
		"<table>" +
