function onInit(argus) {
    ...
    GRID.init({
        ...
        service_infor:{
            className  : "test.eunjustudysetup.EunJuStudySetup",
            method     : { "list":"test.eunjustudysetup.EunJuStudySetup.select", "save":"save" },
            argus      : {
                p_navi_function:"조회"
            }
        },
...
//        	onclick:function(o) {
//        		//        		console.debug(o);
//        		getUI("test/eunjustudysetup","write",{
//        			method:"POST",
//        			argus : {
...
function onLoad(o,argus) { // o.mode : I/U/D/M/R/SORT
    $(".btn_modify").click(function(e) {
        ...
        getUI("test/eunjustudysetup","write",{
            method:"POST",
            argus : {
              p_user_no:GRID.getValue($S("tbl_list"),tr.rowIndex,"user_no")
