...
<span id=area_tech_m_cat><select name=s_m_cat><option>-중분류-</option></select></span>
<span id=area_tech_s_cat><select name=s_s_cat><option>-소분류-</option></select></span>
<hr>
<span id=area_tech_rl_cat><input type=radio></span><hr>
<span id=area_tech_rm_cat><input type=radio></span><hr>
<span id=area_tech_rs_cat><input type=radio></span>
