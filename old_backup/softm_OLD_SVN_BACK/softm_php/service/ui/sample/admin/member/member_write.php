...
<caption>
일반회원 정보<?=$mode=='I'?'입력':'수정'?>
</caption>

  <tr>
    <td width="100%" colspan=4>
        <span id='msg' style='width:100%;top:130;left:1200;font-weight:bold;color:#CC0000;display:none1'>&nbsp;</span>
    </td>
  </tr>
...
<?
    if ( $mode == 'I' ) {
        ...
        echo '<input name="user_level" type="hidden" value="' . ($mode=='I'?'1':$rs[USER_LEVEL])  . '">';
    } else {
...
<input name="tel2_3" id="tel2_3" type="text" style="width:50px ;" maxlength=4 value='<?=$tel2Info[2]?>'>
  ...
  <tr>
    <td colspan="4" class="c-align"><a href='#' onclick='일반회원작성실행("<?=$mode?>");return false;'>
