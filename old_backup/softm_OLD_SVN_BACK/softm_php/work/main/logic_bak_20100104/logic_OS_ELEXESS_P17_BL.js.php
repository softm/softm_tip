...
설계팀 삭제*/
    ...
    passengers:{  //( Excel 로직 )
        ...
        L5007:{
            ...
            'if==1':{
                passengers:{
                    'if==7' :{set:[{object:'E5005',value:1},{object:'car_width',value:'(1401).format()'},{object:'car_depth',value:'(900).format()' },{object:'hoistway_width',value:'(1800).format()'},{object:'hoistway_depth',value:'(1500).format()'}]},
            ...
            'if!=1':{
                passengers:{
                    'if==6' :{set:[{object:'E5005',value:1},{object:'car_width',value:'(1402).format()'},{object:'car_depth',value:'(900).format()' },{object:'hoistway_width',value:'(1800).format()'},{object:'hoistway_depth',value:'(1500).format()'}]},
