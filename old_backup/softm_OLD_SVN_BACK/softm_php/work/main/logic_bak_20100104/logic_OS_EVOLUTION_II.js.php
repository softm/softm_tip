...
설계팀 삭제*/
    ...
    passengers:{  //( Excel 로직 )
        ...
        L5007:{
            ...
            'if==1':{
                passengers:{
                    'if==17':{set:[{object:'E5005',value:1},{object:'car_width',value:'(1600).format()'},{object:'car_depth',value:'(1600).format()'},{object:'hoistway_width',value:'(2350).format()'},{object:'hoistway_depth',value:'(2150).format()'}]},
                    'if==20':{set:[{object:'E5005',value:2},{object:'car_width',value:'(1800).format()'},{object:'car_depth',value:'(1600).format()'},{object:'hoistway_width',value:'(2550).format()'},{object:'hoistway_depth',value:'(2300).format()'}]},
                    'if==24':{set:[{object:'E5005',value:3},{object:'car_width',value:'(2000).format()'},{object:'car_depth',value:'(1700).format()'},{object:'hoistway_width',value:'(2750).format()'},{object:'hoistway_depth',value:'(2450).format()'}]}
                }
            },
            'if!=1':{
                passengers:{
