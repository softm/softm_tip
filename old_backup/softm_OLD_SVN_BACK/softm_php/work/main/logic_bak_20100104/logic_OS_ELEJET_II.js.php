...
var logicJson = {
    ...
    E5006:{
        ...
        L5007:{
            ...
            'if==1_==1_==2.00' :{set:[{object:'E5010',value:"(5400).format()"},{object:'E5011',value:"(2150).format()"}]},
            'if==1_==2_==2.50' :{set:[{object:'E5010',value:"(5600).format()"},{object:'E5011',value:"(2450).format()"}]},
            'if==1_==3_==3.00' :{set:[{object:'E5010',value:"(5900).format()"},{object:'E5011',value:"(2750).format()"}]},
            'if==1_==4_==3.50' :{set:[{object:'E5010',value:"(6500).format()"},{object:'E5011',value:"(3250).format()"}]},
            'if==1_==5_==4.00' :{set:[{object:'E5010',value:"(7100).format()"},{object:'E5011',value:"(3850).format()"}]},
            'if==1_==6_==5.00' :{set:[{object:'E5010',value:"(7800).format()"},{object:'E5011',value:"(4050).format()"}]},
            'if!=1_==1_==2.00' :{set:[{object:'E5010',value:"(4800).format()"},{object:'E5011',value:"(2200).format()"}]},
            'if!=1_==2_==2.50' :{set:[{object:'E5010',value:"(5000).format()"},{object:'E5011',value:"(2450).format()"}]},
            'if!=1_==3_==3.00' :{set:[{object:'E5010',value:"(5300).format()"},{object:'E5011',value:"(2600).format()"}]},
            'if!=1_==4_==3.50' :{set:[{object:'E5010',value:"(5600).format()"},{object:'E5011',value:"(3000).format()"}]},
            'if!=1_==5_==4.00' :{set:[{object:'E5010',value:"(6500).format()"},{object:'E5011',value:"(3550).format()"}]},
            'if!=1_==6_==5.00' :{set:[{object:'E5010',value:"(7200).format()"},{object:'E5011',value:"(5100).format()"}]},
            'if!=1_==7_==6.00' :{set:[{object:'E5010',value:"(8300).format()"},{object:'E5011',value:"(4050).format()"}]}
        }
    },
...
설계팀 삭제*/
    ...
    door_ground:{
        ...
        'if==1_=="E"':{set:[{object:'E5019',value:'12'},{object:'E5021',value:'1'}]},
        ...
        'if==1_=="I"':{set:[{object:'E5019',value:'26'},{object:'E5021',value:'1'}]},
        'if==2_=="I"':{set:[{object:'E5019',value:'15'},{object:'E5021',value:'1'}]},
        'if==3_=="I"':{set:[{object:'E5019',value:'17'},{object:'E5021',value:'1'}]},
        'if==4_=="I"':{set:[{object:'E5019',value:'16'},{object:'E5021',value:'1'}]},
        'if==5_=="I"':{set:[{object:'E5019',value:'18'},{object:'E5021',value:'1'}]},
        'if==6_=="I"':{set:[{object:'E5019',value:'18'},{object:'E5021',value:'1'}]},
    ...
    door_typical:{
        ...
        'if==1_=="I"':{set:[{object:'E5022',value:'23'},{object:'E5023',value:'$("E5009").value.toNumber()-1'}]},
        'if==2_=="I"':{set:[{object:'E5022',value:'15'},{object:'E5023',value:'$("E5009").value.toNumber()-1'}]},
        'if==3_=="I"':{set:[{object:'E5022',value:'17'},{object:'E5023',value:'$("E5009").value.toNumber()-1'}]},
        'if==4_=="I"':{set:[{object:'E5022',value:'16'},{object:'E5023',value:'$("E5009").value.toNumber()-1'}]},
        'if==5_=="I"':{set:[{object:'E5022',value:'18'},{object:'E5023',value:'$("E5009").value.toNumber()-1'}]},
        'if==6_=="I"':{set:[{object:'E5022',value:'18'},{object:'E5023',value:'$("E5009").value.toNumber()-1'}]},
        'if==7'      :{set:[{object:'E5022',value:'1' },{object:'E5023',value:'0'}                            ]}
    },

    jamb_ground:{
        source:['jamb_ground','jamb_ground_option','transom_ground'],
        'if==2_=="W"_=="E"':{set:[{object:'E5026',value:'12'},{object:'E5027',value:'1'}]},
        'if==4_=="W"_=="E"':{set:[{object:'E5026',value:'13'},{object:'E5027',value:'1'}]},
        'if==6_=="W"_=="E"':{set:[{object:'E5026',value:'14'},{object:'E5027',value:'1'}]},
        ...
        'if==2_=="W"_=="I"':{set:[{object:'E5026',value:'23'},{object:'E5027',value:'1'}]},
        'if==4_=="W"_=="I"':{set:[{object:'E5026',value:'24'},{object:'E5027',value:'1'}]},
        'if==6_=="W"_=="I"':{set:[{object:'E5026',value:'25'},{object:'E5027',value:'1'}]},
    ...
    jamb_typical:{
        ...
        'if==2_=="W"_=="E"':{set:[{object:'E5028',value:'12'},{object:'E5029',value:'$("E5009").value.toNumber()-1'}]},
        'if==4_=="W"_=="E"':{set:[{object:'E5028',value:'13'},{object:'E5029',value:'$("E5009").value.toNumber()-1'}]},
        'if==6_=="W"_=="E"':{set:[{object:'E5028',value:'14'},{object:'E5029',value:'$("E5009").value.toNumber()-1'}]},
        ...
        'if==2_=="W"_=="I"':{set:[{object:'E5028',value:'23'},{object:'E5029',value:'$("E5009").value.toNumber()-1'}]},
        'if==4_=="W"_=="I"':{set:[{object:'E5028',value:'24'},{object:'E5029',value:'$("E5009").value.toNumber()-1'}]},
        'if==6_=="W"_=="I"':{set:[{object:'E5028',value:'25'},{object:'E5029',value:'$("E5009").value.toNumber()-1'}]},
    ...
    cage_panel_n_wall:{
        'if==1':{set:[{object:'E5035',value:'12'}]},
    ...
    car_door:{
        'if==1':{set:[{object:'E5041',value:'12'}]},
    ...
    passengers:{  //( Excel 로직 )
        ...
        L5007:{
            ...
            'if==1':{
                passengers:{
                    'if==17':{set:[{object:'E5005',value:3},{object:'car_width',value:'(1800).format()'},{object:'car_depth',value:'(1500).format()'},{object:'hoistway_width',value:'(2400).format()'},{object:'hoistway_depth',value:'(2400).format()'}]},
                    'if==20':{set:[{object:'E5005',value:4},{object:'car_width',value:'(1800).format()'},{object:'car_depth',value:'(1700).format()'},{object:'hoistway_width',value:'(2500).format()'},{object:'hoistway_depth',value:'(2600).format()'}]},
                    'if==24':{set:[{object:'E5005',value:5},{object:'car_width',value:'(2000).format()'},{object:'car_depth',value:'(1750).format()'},{object:'hoistway_width',value:'(2700).format()'},{object:'hoistway_depth',value:'(2650).format()'}]}
                }
            },
            'if!=1':{
                passengers:{
                    'if==15':{set:[{object:'E5005',value:3},{object:'car_width',value:'(1800).format()'},{object:'car_depth',value:'(1500).format()'},{object:'hoistway_width',value:'(2400).format()'},{object:'hoistway_depth',value:'(2400).format()'}]},
                    'if==18':{set:[{object:'E5005',value:4},{object:'car_width',value:'(1800).format()'},{object:'car_depth',value:'(1700).format()'},{object:'hoistway_width',value:'(2500).format()'},{object:'hoistway_depth',value:'(2600).format()'}]},
                    'if==21':{set:[{object:'E5005',value:5},{object:'car_width',value:'(2000).format()'},{object:'car_depth',value:'(1750).format()'},{object:'hoistway_width',value:'(2700).format()'},{object:'hoistway_depth',value:'(2650).format()'}]}
                }
            }
        }
    },
