...
var logicJson = {
    ...
    L5005_5007:{
        ...
        'if==1':{
            set:[{object:'passengers',value:'Math.round($("E5005").options[$("E5005").selectedIndex].text/68,0)'}],
            E5005:{
                'if==1':{set:[{object:'car_width',value:'(1100).format()'},{object:'car_depth',value:'(1300).format()'},{object:'hoistway_width',value:'(1850).format()'},{object:'hoistway_depth',value:'(1700).format()'}]},
                'if==2':{set:[{object:'car_width',value:'(1100).format()'},{object:'car_depth',value:'(1400).format()'},{object:'hoistway_width',value:'(1850).format()'},{object:'hoistway_depth',value:'(1800).format()'}]},
                'if==3':{set:[{object:'car_width',value:'(1300).format()'},{object:'car_depth',value:'(1300).format()'},{object:'hoistway_width',value:'(1950).format()'},{object:'hoistway_depth',value:'(1700).format()'}]},
                'if==4':{set:[{object:'car_width',value:'(1300).format()'},{object:'car_depth',value:'(1400).format()'},{object:'hoistway_width',value:'(1950).format()'},{object:'hoistway_depth',value:'(1800).format()'}]},
                'if==5':{set:[{object:'car_width',value:'(1500).format()'},{object:'car_depth',value:'(1400).format()'},{object:'hoistway_width',value:'(2150).format()'},{object:'hoistway_depth',value:'(1800).format()'}]},
                'if==6':{set:[{object:'car_width',value:'(1600).format()'},{object:'car_depth',value:'(1400).format()'},{object:'hoistway_width',value:'(2200).format()'},{object:'hoistway_depth',value:'(1800).format()'}]}
            }
        },
        'if!=1':{
