...
var logicJson = {
    ...
    L5005_5007:{
        ...
        'if==1':{
            set:[{object:'passengers',value:'Math.round($("E5005").options[$("E5005").selectedIndex].text/68,0)'}],
            E5005:{
                'if==3':{set:[{object:'car_width',value:'(1800).format()'},{object:'car_depth',value:'(1500).format()'},{object:'hoistway_width',value:'(2400).format()'},{object:'hoistway_depth',value:'(2400).format()'}]},
                'if==4':{set:[{object:'car_width',value:'(1800).format()'},{object:'car_depth',value:'(1700).format()'},{object:'hoistway_width',value:'(2500).format()'},{object:'hoistway_depth',value:'(2600).format()'}]},
                'if==5':{set:[{object:'car_width',value:'(2000).format()'},{object:'car_depth',value:'(1750).format()'},{object:'hoistway_width',value:'(2700).format()'},{object:'hoistway_depth',value:'(2650).format()'}]}
            }
        },
        'if!=1':{
...
/* 2010년 9월 3일 금요일 해영요청 삭제 (화면에서 항목없어짐)
...
*/
    ...
    map:{
        ...
        car_door                :['car_door'],
      //counter_weight_safety   :['counter_weight_safety'], // 2010년 9월 3일 금요일 해영요청 삭제(화면에서 제거)
...
*/
    E5005:{
        'if==5':{set:[{object:'E5006',INCLUDE:[1,2]}]},
        'if'   :{set:[{object:'E5006',EXCLUDE:['']}]}
    },
