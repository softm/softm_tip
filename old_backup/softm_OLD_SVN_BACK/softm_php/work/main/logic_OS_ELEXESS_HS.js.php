...
var logicJson = {
    ...
    L5005_5007:{
        ...
        'if==1':{
            set:[{object:'passengers',value:'Math.round($("E5005").options[$("E5005").selectedIndex].text/68,0)'}],
            E5005:{
                'if==1':{set:[{object:'car_width',value:'(1600).format()'},{object:'car_depth',value:'(1350).format()'},{object:'hoistway_width',value:'(2200).format()'},{object:'hoistway_depth',value:'(2150).format()'}]},
                'if==2':{set:[{object:'car_width',value:'(1600).format()'},{object:'car_depth',value:'(1500).format()'},{object:'hoistway_width',value:'(2200).format()'},{object:'hoistway_depth',value:'(2300).format()'}]},
                'if==3':{set:[{object:'car_width',value:'(1800).format()'},{object:'car_depth',value:'(1500).format()'},{object:'hoistway_width',value:'(2400).format()'},{object:'hoistway_depth',value:'(2300).format()'}]},
                'if==4':{set:[{object:'car_width',value:'(1800).format()'},{object:'car_depth',value:'(1700).format()'},{object:'hoistway_width',value:'(2400).format()'},{object:'hoistway_depth',value:'(2500).format()'}]},
                'if==5':{set:[{object:'car_width',value:'(2000).format()'},{object:'car_depth',value:'(1750).format()'},{object:'hoistway_width',value:'(2600).format()'},{object:'hoistway_depth',value:'(2550).format()'}]}
            }
        },
        'if!=1':{
