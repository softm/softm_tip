...
var logicJson = {
    ...
    L5005_5007:{
        ...
        'if==1':{
            set:[{object:'passengers',value:'Math.round($("E5005").options[$("E5005").selectedIndex].text/68,0)'}],
            E5005:{
                'if==3':{set:[{object:'car_width',value:'(1300).format()'},{object:'car_depth',value:'(1300).format()'},{object:'hoistway_width',value:'(2050).format()'},{object:'hoistway_depth',value:'(1700).format()'}]},
                'if==4':{set:[{object:'car_width',value:'(1300).format()'},{object:'car_depth',value:'(1400).format()'},{object:'hoistway_width',value:'(2050).format()'},{object:'hoistway_depth',value:'(1800).format()'}]},
                'if==5':{set:[{object:'car_width',value:'(1500).format()'},{object:'car_depth',value:'(1400).format()'},{object:'hoistway_width',value:'(2250).format()'},{object:'hoistway_depth',value:'(1800).format()'}]},
                'if==6':{set:[{object:'car_width',value:'(1600).format()'},{object:'car_depth',value:'(1400).format()'},{object:'hoistway_width',value:'(2350).format()'},{object:'hoistway_depth',value:'(1800).format()'}]},
                'if==7':{set:[{object:'car_width',value:'(1600).format()'},{object:'car_depth',value:'(1600).format()'},{object:'hoistway_width',value:'(2350).format()'},{object:'hoistway_depth',value:'(2000).format()'}]}
            }
        },
        'if!=1':{
    ...
    L5007_5006_velocity:{
        ...
        'if==1_==1_==1.00' :{set:[{object:'E5010',value:"(4000).format()"},{object:'E5011',value:"(1400).format()"}]},
        'if==1_==2_==1.50' :{set:[{object:'E5010',value:"(4100).format()"},{object:'E5011',value:"(1550).format()"}]},
        'if==1_==3_==1.75' :{set:[{object:'E5010',value:"(4200).format()"},{object:'E5011',value:"(1550).format()"}]},
        'if!=1_==1_==1.00' :{set:[{object:'E5010',value:"(4000).format()"},{object:'E5011',value:"(1400).format()"}]},
        'if!=1_==2_==1.50' :{set:[{object:'E5010',value:"(4100).format()"},{object:'E5011',value:"(1550).format()"}]},
        'if!=1_==3_==1.75' :{set:[{object:'E5010',value:"(4200).format()"},{object:'E5011',value:"(1550).format()"}]}
    },
