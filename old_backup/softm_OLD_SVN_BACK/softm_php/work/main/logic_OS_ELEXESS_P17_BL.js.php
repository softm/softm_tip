...
var logicJson = {
    ...
    L5005_5007:{
        ...
        'if==1':{
            set:[{object:'passengers',value:'Math.round($("E5005").options[$("E5005").selectedIndex].text/68,0)'}],
            E5005:{
                'if==1':{set:[{object:'car_width',value:'(1400).format()'},{object:'car_depth',value:'(900).format()' },{object:'hoistway_width',value:'(1800).format()'},{object:'hoistway_depth',value:'(1500).format()'}]},
                'if==3':{set:[{object:'car_width',value:'(1400).format()'},{object:'car_depth',value:'(1100).format()'},{object:'hoistway_width',value:'(1800).format()'},{object:'hoistway_depth',value:'(1750).format()'}]},
                'if==4':{set:[{object:'car_width',value:'(1400).format()'},{object:'car_depth',value:'(1250).format()'},{object:'hoistway_width',value:'(1800).format()'},{object:'hoistway_depth',value:'(1850).format()'}]},
                'if==5':{set:[{object:'car_width',value:'(1400).format()'},{object:'car_depth',value:'(1350).format()'},{object:'hoistway_width',value:'(1800).format()'},{object:'hoistway_depth',value:'(2000).format()'}]},
                'if==6':{set:[{object:'car_width',value:'(1600).format()'},{object:'car_depth',value:'(1350).format()'},{object:'hoistway_width',value:'(2100).format()'},{object:'hoistway_depth',value:'(2100).format()'}]},
                'if==7':{set:[{object:'car_width',value:'(1600).format()'},{object:'car_depth',value:'(1500).format()'},{object:'hoistway_width',value:'(2100).format()'},{object:'hoistway_depth',value:'(2100).format()'}]},
                'if==8':{set:[{object:'car_width',value:'(1800).format()'},{object:'car_depth',value:'(1500).format()'},{object:'hoistway_width',value:'(2350).format()'},{object:'hoistway_depth',value:'(2350).format()'}]}
            }
        },
        'if!=1':{
    ...
    L5007_5006_velocity:{
        ...
        'if==1_==1_==1'   :{set:[{object:'E5010',value:"(4450).format()"},{object:'E5011',value:"(1500).format()"}]},
        ...
        'if!=1_==1_==1'   :{set:[{object:'E5010',value:"(4150).format()"},{object:'E5011',value:"(1460).format()"}]},
        'if!=1_==1_==1'   :{set:[{object:'E5010',value:"(4300).format()"},{object:'E5011',value:"(1600).format()"}]},
        'if!=1_==2_==1.5' :{set:[{object:'E5010',value:"(4600).format()"},{object:'E5011',value:"(1600).format()"}]},
        'if!=1_==3_==1.75':{set:[{object:'E5010',value:"(4600).format()"},{object:'E5011',value:"(1860).format()"}]}
    },
...
var optionAmountJson = {
    ...
    fireman_emergency_return    :{ 
        //set:[{style:'fireman_emergency_return',color:'"red"'}],
        //set:[{style:'tr_spare_parts_set',display:'"none"'}],
        'if=="I"':{set:[{object:'opt_amt_fireman_emergency_return'  ,value:'385000 * $("total_unit").value.toNumber()'},{style:'fireman_emergency_return',color:'"red"'}]},
        'if'     :{set:[{object:'opt_amt_fireman_emergency_return'  ,value:'0'}]}
    },
