...
var logicJson = {
    ...
    L5005_5007:{
        ...
        'if==1':{
            set:[{object:'passengers',value:'Math.round($("E5005").options[$("E5005").selectedIndex].text/68,0)'}],
            E5005:{
                'if==1':{set:[{object:'car_width',value:'(1800).format()'},{object:'car_depth',value:'(1700).format()'},{object:'hoistway_width',value:'(2350).format()'},{object:'hoistway_depth',value:'(2450).format()'}]},
                'if==2':{set:[{object:'car_width',value:'(2000).format()'},{object:'car_depth',value:'(1750).format()'},{object:'hoistway_width',value:'(2550).format()'},{object:'hoistway_depth',value:'(2500).format()'}]}
            }
        },
        'if!=1':{
