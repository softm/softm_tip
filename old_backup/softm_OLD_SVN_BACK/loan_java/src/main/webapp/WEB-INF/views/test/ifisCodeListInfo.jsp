...
for (int j = 0 ; j < arrCodegrp.length; j++) {
	...
	if ("48".equals(arrCodegrp[j]) ) {
		list.add(new CodeListItemDTO("KTF","KTF"    ));		
		list.add(new CodeListItemDTO("KTU","KT알뜰폰" ));		
		list.add(new CodeListItemDTO("LGT","LGT"    ));		
		list.add(new CodeListItemDTO("LGU","LG알뜰폰" ));		
		list.add(new CodeListItemDTO("SKT","SKT"    ));		
		list.add(new CodeListItemDTO("SKU","SKT알뜰폰"));		
