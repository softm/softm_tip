...
$( document ).ready(function() {
	...
	$( "body" ).off("click", "#prevPage").on( "click", "#prevPage", function() {
	...
	$( "body" ).off("click", ".anchor_month").on( "click", ".anchor_month", function() {
	    ...
	    loadUi("#page2","/mainSlideView.do",params,function(){});    			    
	});
	...
	exec("/mainSlideInfo.do", params.join("&"),function(data) {
      ...
      if ( data.RESULT_CD == RESULT_CD.OK ) {
          $( "#spnCnt1" ).text(data.CNT1);
          $( "#spnCnt2" ).text(data.CNT2);
          $( "#spnCnt3" ).text(data.CNT3);
          $( "#spnCnt4" ).text(data.CNT4);
      } else {
      }
	});
});
...
<img id="imgMyPic" src="" width="50"/>
<span id="spnUserName">~</span>
<span id="spnDeptName">~</span>
<br/>
<br/>
<button id="btnCalc">금융계산기</button>
<br/>
<br/>

<span id="spnCurYyyymmdd">${year}년 ${month}월 ${day}일 (${dayName}요일)</span>
<br/>
<br/>

고객상담
<span id="spnCnt1">____</span> 건
사전품의
<span id="spnCnt2">____</span> 건
여신거래약정
<span id="spnCnt3">____</span> 건
당월실행
<span id="spnCnt4">____</span> 건
<br/>
<br/>
      <table border ='1'>
        <tr>
