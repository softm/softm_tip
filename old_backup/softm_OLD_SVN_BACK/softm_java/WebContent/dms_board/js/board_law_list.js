...
function fView(no, s_code, s_subject, s_context) {
	getUI("dms_board", "board_law_view", {argus:{p_no:no,s_code:s_code,s_subject:s_subject,s_context:s_context}});
}

function fWrite() {
	getUI("dms_board", "board_law_write", {argus:{p_mode:'I'}});
	return false;
}
