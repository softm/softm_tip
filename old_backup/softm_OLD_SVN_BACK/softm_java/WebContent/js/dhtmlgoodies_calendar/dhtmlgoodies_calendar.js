...
var pathToImages = 'http://just10.co.kr/service/common/js/dhtmlgoodies_calendar/images/';	// Relative to your HTML file
...
function pickDate(e,inputDay)
{
    ...
    if (returnDateTo.onSetValue) returnDateTo.onSetValue();
