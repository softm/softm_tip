...
var jscolor = {
	dir : '/service/common/js/xquared_client/images/plugin/colorpicker/', // location of jscolor directory (leave empty to autodetect);
