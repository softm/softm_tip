	...
	executeJobs: function() {
		...
		if ( this.jobs ) {
            for(var id in this.jobs) {
                ...
                if(typeof(job) =='object' && typeof (job.lastExecution ) != 'undefined' && job.lastExecution && job.lastExecution.elapsed(job.interval, curDate)) {
                    try {
...
xq.Editor = xq.Class(/** @lends xq.Editor.prototype */{
	 ...
	 */
	 initialize: function(contentElement, toolbarContainer) {
		 ...
		 * @type String
		 */
		this.config.imagePathForDefaultToolbar = '/service/common/js/xquared_client/images/toolbar/';
		
		/**
		 * Image path for content.
		 * @type String
		 */
		this.config.imagePathForContent = '/service/common/js/xquared_client/images/content/';
		
		/**
		 * Image path for dialog.
		 * @type String
		 */
		this.config.imagePathForDialog = '/service/common/js/xquared_client/images/dialogs/';
		
		/**
		 * Image path for emoticon.
		 * @type String
		 */
		this.config.imagePathForEmoticon = '/service/common/js/xquared_client/images/dialogs/emoticon/';
