...
public class DmsBoardNoticeDAO{

	protected Logger Log = Util.logger; 

	public JSONObject getBoardNoticeList() throws Exception {
		Connection con = null;
		...
		try {
			...
			System.out.println("getBoardNoticeList 에러 : " + ex);
		} finally {
	...
	public boolean getBoardNoticeUpdate( JSONObject jso ) throws Exception {
		Connection con = null;
		PreparedStatement pstmt = null;
		int result = 0;
		StringBuffer sql = new StringBuffer();
