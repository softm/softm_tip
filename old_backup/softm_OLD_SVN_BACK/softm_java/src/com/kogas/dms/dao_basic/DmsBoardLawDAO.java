...
public class DmsBoardLawDAO{

	protected Logger Log = Util.logger; 

	public JSONObject getBoardLawList() throws Exception {
		Connection con = null;
		...
		try {
			...
			System.out.println("getBoardLawList 에러 : " + ex);
		} finally {
	...
	public boolean getBoardLawUpdate( JSONObject jso ) throws Exception {
		Connection con = null;
		PreparedStatement pstmt = null;
		int result = 0;
		StringBuffer sql = new StringBuffer();
