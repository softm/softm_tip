...
public class DmsBoardBasicDAO extends BaseDAO {

	public DmsBoardBasicDAO() throws Exception {
		super();
	 ...
	 * @throws Exception
	 */
	public JSONObject getBoardBasicList ( 
        ...
        sql.append("                                  FROM DMS_BOARD_BASIC A1, DMS_BOARD_CODE A2").append("\n");
...
//        Log.info(sql.toString());
	...
	public JSONObject getBoardBasicDetail(int no) throws Exception {
		...
		sql.append("              ,REAL_ATT_FILE ").append("\n");
		sql.append("              ,DISPLAY_ATT_FILE  ").append("\n");
		sql.append("         FROM DMS_BOARD_BASIC A,  ").append("\n");
	 ...
	 * @throws Exception
	 */
	public JSONArray getBoardBasicNextList ( 
        ...
        sql.append("               SELECT MAX(NO) FROM DMS_BOARD_BASIC ").append("\n");
        ...
        sql.append("   FROM DMS_BOARD_BASIC  ").append("\n");
        sql.append("  WHERE NO IN ( ").append("\n");
        sql.append("               SELECT MIN(NO) FROM DMS_BOARD_BASIC ").append("\n");
        sql.append("                WHERE NO > ? ").append("\n");
        if(!s_code.equals("")) sql.append(" AND CODE = '").append(s_code).append("' ").append("\n");
        if(!s_subject.equals("")) sql.append(" AND SUBJECT LIKE '%").append(s_subject).append("%' ").append("\n");
        if(!s_context.equals("")) sql.append(" AND CONTEXT LIKE '%").append(s_context).append("%' ").append("\n");
	...
	public boolean insertBoardBasic(JSONObject jso) {
		...
		sql.append("         DMS_BOARD_BASIC_SEQ.NEXTVAL ").append("\n");
		sql.append("        ,? ").append("\n");
		sql.append("        ,? ").append("\n");
		sql.append("        ,? ").append("\n");
		sql.append("        ,? ").append("\n");
	 ...
	 * @throws Exception
	 */
	public boolean updateBoardBasic( JSONObject jso ) throws Exception {
		int result = 0;
		StringBuffer sql = new StringBuffer();
	...
	public void setReadCountUpdate(int no) throws Exception {
		StringBuffer sql = new StringBuffer();
		sql.append(" UPDATE DMS_BOARD_BASIC SET READ_COUNT = READ_COUNT+1 WHERE NO = ? ");
		try{
			pstmt = DBUtil.getConnection().prepareStatement(sql.toString());
			pstmt.setInt(1, no);
			pstmt.executeUpdate();
