...
public class DmsBdRequestDAO extends BaseDAO{

	public DmsBdRequestDAO() throws Exception {
		super();
	}
	...
	public JSONArray list() throws Exception{
        ...
        try {
            ...
            sql.append(
	            ...
	            + "     REAL_ATT_FILE   ,"
	            + "     DISPLAY_ATT_FILE "
	            + " FROM " + TABLE.TBL_DMS_BD_REQUEST + " a "
	            + " WHERE 0 = 0"
...
//            pstmt.setString(sIdx++, s_year + s_month);
	 ...
	 * @throws Exception
	 */
	public JSONObject view(int s_req_no) throws Exception{
        JSONObject jso = new JSONObject();
        try {
            StringBuffer sql = new StringBuffer();
            sql.append(
	 ...
	 * @throws Exception
	 */
	public JSONObject getFileInfo(int p_req_no) throws Exception{
		JSONObject jso = new JSONObject();
		try {
			StringBuffer sql = new StringBuffer();
			sql.append(
	...
	public boolean insert(JSONObject vo) throws Exception {
		try {
			...
			StringBuffer sql = new StringBuffer();
            sql.append("INSERT INTO " + TABLE.TBL_DMS_BD_REQUEST + "("
                    + "     REQ_NO          ,"
                    + "     ITEM_NO         ,"
                    + "     MEMBER_NO       ,"
                    + "     WRIET_DATE      ,"
                    ...
                    + " VALUES "
                    + " ( "
                    + "     " + TABLE.TBL_DMS_BD_REQUEST + "_SEQ.NEXTVAL,"		
                    + "     ?,"
                    + "     ?,"
                    + "     ?,"
                    + "     ?,"
    ...
    public boolean update(JSONObject vo) throws Exception {
        try {
            ...
            StringBuffer sql = new StringBuffer();
            sql.append("UPDATE " + TABLE.TBL_DMS_BD_REQUEST + " SET"
//                    + "     REQ_NO          = ?,"
//                    + "     ITEM_NO         = ?,"
//                    + "     MEMBER_NO       = ?,"
//                    + "     WRIET_DATE      = ?,"
...
//            pstmt.setString(sIdx++, (String) vo.get("DISPLAY_ATT_FILE"));
            pstmt.setString(sIdx++, (String) vo.get("TITLE"           ));
            pstmt.setInt   (sIdx++, (Integer) vo.get("REQ_NO"          ));
	...
	public boolean delete(JSONObject vo) throws Exception {
		try {
			StringBuffer sql = new StringBuffer();
            sql.append("DELETE FROM " + TABLE.TBL_DMS_BD_REQUEST + " "
                    + " WHERE REQ_NO = ?"
            );
			pstmt = DBUtil.getConnection().prepareStatement(sql.toString());            
			Log.debug(sql.toString());
     ...
     * @throws Exception
     */
    public boolean updateStatus(String p_req_no, String p_status) throws Exception {
    	try {
    		if ( 
    				p_req_no == null ||
    				p_status == null
    		...
    		pstmt.setInt   (sIdx++, Integer.valueOf(p_req_no));
