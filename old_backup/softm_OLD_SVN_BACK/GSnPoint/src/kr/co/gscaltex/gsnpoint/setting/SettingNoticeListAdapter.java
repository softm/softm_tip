...
public class SettingNoticeListAdapter extends BaseAdapter {
...
//	}
	...
	public SettingNoticeListAdapter(Context context) {
		mContext = context;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		SettingNoticeTextView itemView;
		
		if (convertView == null) {
			itemView = new SettingNoticeTextView(mContext, mItems.get(position));
		} else {
			itemView = (SettingNoticeTextView) convertView;			
