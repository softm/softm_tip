...
public class SeedX {
	...
	/**
	 * 한국정보보호진흥원 소스에 없는 추가 된 함수로<br>
	 * 입력 받은 바이트 데이터를 암호화 하여 리턴한다.<br>
	 * 
	 * @param sbuffer String 평문
	...
	/**
	 * 한국정보보호진흥원 소스에 없는 추가 된 함수로<br>
	 * 입력 받은 문자열을 특정 Charset으로 변환하여 암호화 하여 리턴한다.<br>
	 * 
	 * @param inData String 평문
	 * @param szKey byte[] key
	 * @param charset String String을 byte 데이터로 변환할때 사용할 charset
	 * @return byte[] 암호화 된 데이터
	 * @throws UnsupportedEncodingException charset이 없는 경우 발생한다.
	 */
	...
	/**
	 * 한국정보보호진흥원 소스에 없는 추가 된 함수로 암호화 된 바이트 데이터를<br>
	 * 받아서 복호화한다.<br>
	 * 
	...
	/**
	 * 한국정보보호진흥원 소스에 없는 추가 된 함수로 암호화 된 바이트 데이터를 <br>
	 * 받아서 복호화하여 지정한 charset으로 문자열로 반환한다.<br>
	 * 
	 * @param encryptBytes byte[] 암호화 된 바이트 데이터
	 * @param szKey byte[] key
	 * @param charset 복호화 된 바이트 데이터를 문자열로 변환할 때 사용할 Charset
	 * @return byte[] 복호화 된 바이트 데이터
	 * @throws UnsupportedEncodingException charset이 없는 경우 발생한다.
	 */
	public String decryptAsString(byte[] encryptBytes, byte[] szKey,
