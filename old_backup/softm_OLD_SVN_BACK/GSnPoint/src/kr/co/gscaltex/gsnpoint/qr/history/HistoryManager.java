...
package kr.co.gscaltex.gsnpoint.qr.history;
...
import kr.co.gscaltex.gsnpoint.qr.Intents;
...
public final class HistoryManager {
	...
	static Uri saveHistory(String history) {
		...
		if (!historyRoot.exists() && !historyRoot.mkdirs()) {
			//Debug.trace(TAG, "Couldn't make dir " + historyRoot);
			return null;
		}
		...
		try {
			...
			//Debug.trace(TAG, "Couldn't access file " + historyFile + " due to " + ioe);
			return null;
		}
		finally {
			if (out != null) {
