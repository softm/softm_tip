...
//            startActivityForResult(intent, Constant.ZBAR_SCANNER_REQUEST);
    		startActivityFromChild(this, intent, Constant.ZBAR_SCANNER_REQUEST);
        } else {
...
//            startActivityForResult(intent, Constant.ZBAR_SCANNER_REQUEST);
            startActivityForResult(intent, Constant.ZBAR_QR_SCANNER_REQUEST);
        } else {
            Toast.makeText(this, "Rear Facing Camera Unavailable", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void setText(int id, String v) {
		...
		if ( vw instanceof TextView ) {
			...
			SpinnerCd sp = (SpinnerCd) findViewById(id);
			sp.setValue(v);
		}
    }
     ...
     * @param v
     */
    protected void setFocus(int id) {
		setFocus(id,true);
    }
    /**
     * 포커스 이동 & keyboard 표시 여부 설정
     * @param v
     */
    protected void setFocus(int id,boolean keyboard) {
     ...
     * @param v
     */
    protected void setFocus(final View v,boolean keyboard) {
		v.requestFocus();
		if ( keyboard ) {
     ...
     * @param v
     */
    protected void setFocus(final View v) {
    	setFocus(v,true);
    }
