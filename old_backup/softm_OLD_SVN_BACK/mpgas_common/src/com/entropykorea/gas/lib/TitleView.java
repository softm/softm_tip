...
//		ViewGroup group = (ViewGroup) activity.getWindow().getDecorView();
	...
	private void initLayout(Activity activity, String title, ViewGroup group,boolean button1, boolean button2) {
		if ( this.activity == null ) {
			LayoutInflater layout = activity.getLayoutInflater();
			View view = layout.inflate(R.layout.layout_title, null);
			TextView textView = (TextView)view.findViewById(R.id.title_text);
			ImageButton imgBtnBack = (ImageButton)view.findViewById(R.id.btn_back);
...
//		});
	...
	private void initLayoutNoButton(Activity activity, String title, ViewGroup group) {
		if ( this.activity == null ) {		
			LayoutInflater layout = activity.getLayoutInflater();
			View view = layout.inflate(R.layout.layout_title, null);
			TextView textView = (TextView)view.findViewById(R.id.title_text);
...
//		imgBtn.setBackgroundDrawable(activity.getResources().getDrawable(id));		
	...
	public void onClick(View v) {
		...
		if ( R.id.btn_back == viewID  ) {
			topListner.onClickBackButton(v);			
