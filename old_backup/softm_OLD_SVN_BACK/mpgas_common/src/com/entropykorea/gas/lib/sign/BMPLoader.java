package com.entropykorea.gas.lib.sign;
...
public class BMPLoader
{
	...
	protected void getPixelData2() throws IOException, Exception
	{
		rawData = new byte[actualSizeOfBitmap];
			int n = is.read(rawData);
	}

	public void read( String fn ) throws IOException, Exception
	{
		File f = new File( fn );
