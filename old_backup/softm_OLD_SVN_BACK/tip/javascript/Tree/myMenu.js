...
asp_ex.addItem(new TreeMenuItem("Example 1", "about:blank", "mainFrame"));
asp_ex.addItem(new TreeMenuItem("Example 2", "about:blank", "mainFrame"));
asp_ex.addItem(new TreeMenuItem("Example 3", "about:blank", "mainFrame"));
asp_ex.addItem(new TreeMenuItem("Example 4", "about:blank", "mainFrame"));
...
dhtml_ex.addItem(new TreeMenuItem("Navigation Bar", "/dhtml/navbar.html", "_blank"));
...
js_ex.addItem(new TreeMenuItem("Example 1", "about:blank", "mainFrame"));
js_ex.addItem(new TreeMenuItem("Example 2", "about:blank", "mainFrame"));
js_ex.addItem(new TreeMenuItem("Example 3", "about:blank", "mainFrame"));
js_ex.addItem(new TreeMenuItem("Example 4", "about:blank", "mainFrame"));
