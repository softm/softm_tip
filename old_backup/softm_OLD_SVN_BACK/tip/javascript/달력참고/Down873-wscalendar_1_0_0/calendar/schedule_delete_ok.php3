...
<?
   echo("<Html>\n");
   echo("   <Head>\n");
   echo("      <Title>일정 삭제 성공 - WorkSpace</Title>\n");
   ...
   echo("\n");
   echo("         <Table Width='450' Height='340' Cellpadding='0' Cellspacing='0' Border='0' Style='border: 2px dashed #336699'>\n");
   ...
   echo("               <Font Color='#ffffff'><B>일정 삭제 성공</B></Font>\n");
   echo("               </Span>\n");
