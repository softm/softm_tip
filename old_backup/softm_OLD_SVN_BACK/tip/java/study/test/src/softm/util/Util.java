...
////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static String toHungarian(String str) {
		return toHungarian(str,false);
	}
	
	public static String toHungarian(String str,boolean firstCharLower) {
		String arr[] = str.split("_");
		String rtn[] = new String[arr.length];
		
		int idx = -1;
		for( String data : arr ) {
			rtn[++idx] = (idx==0 && firstCharLower?data.toLowerCase().charAt(0):data.toUpperCase().charAt(0)) + data.toLowerCase().substring(1);
		}
