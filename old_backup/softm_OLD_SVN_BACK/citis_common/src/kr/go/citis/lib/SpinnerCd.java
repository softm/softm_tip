...
import kr.go.citis.lib.adapter.CodeAdapter;
...
import kr.go.citis.lib.dto.BaseDataDTO;
import kr.go.citis.lib.dto.CodeDTO;
import kr.go.citis.lib.dto.in.CodeDTOIn;
import kr.go.citis.lib.dto.out.CodeDTOOut;
...
//		setAdapter(adapter);
	...
	public SpinnerCd getCode(String code,String service,final String prompt,String url, final CallBack cb) {
		...
		new AsyncHttp<CodeDTOOut,CodeDTOIn>(this.getContext()) {
			@Override
