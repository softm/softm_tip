...
<tr height=30>
  <td colspan=2 align=right>
     <input type=image border=0 src=<?=$dir?>/btn_confirm.gif onfocus=blur()> <?=$a_list?><img src=<?=$dir?>/images/i_list.gif border=0></a> <?=$a_view?><img src=<?=$dir?>/btn_back.gif border=0></a>
  </td>
</tr>
</table>
<br><br>
