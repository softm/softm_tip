...
function treeMenuDisplay() {
  ...
  treeMenuDocument.writeln('<tr valign=top><td>');
  treeMenuDocument.writeln('<img src="' + treeMenuImgDir + 'menu_root.gif" align=left border=0 vspace=0 hspace=0>');
  treeMenuDocument.writeln('<a href="#" onClick="return parent.treeMenuClickRoot();">');
  treeMenuDocument.writeln('<font face="' + treeMenuFont + '" size=' + treeMenuFontSize + '>&nbsp;' + treeMenuRoot + '&nbsp;</font>');
...
function treeMenuDisplayItem(item) {
  ...
  treeMenuDocument.writeln('<tr valign=top><td nowrap>');
  ...
  for (i = 0; i < treeMenuDepth; i++) {
    if (treeMenuBars[i]) {
      treeMenuDocument.writeln('<img src="' + treeMenuImgDir + 'menu_bar.gif" align=left border=0 vspace=0 hspace=0>');
      bars[i] = true;
    }
    else {
      treeMenuDocument.writeln('<img src="' + treeMenuImgDir + 'menu_spacer.gif" align=left border=0 vspace=0 hspace=0>');
      bars[i] = false;
    }
    if (item.index == treeMenuSelected)
      treeMenuScrollX += 18;
  ...
  if (!more) {
    ...
    treeMenuDocument.writeln('<img src="' + treeMenuImgDir + img + '" align=left border=0 vspace=0 hspace=0>');
  }
  ...
  if (item.url != "")
    treeMenuDocument.writeln('<a href="' + item.url + '" target="' + item.target + '" onClick="' + cmd + '">');
  else
    treeMenuDocument.writeln('<a href="#" onClick="' + cmd + '">');
  ...
  if (treeMenuAltText)
    ...
    alt = '';
  treeMenuDocument.writeln('<img src="' + treeMenuImgDir + img + '"' + alt + ' align=left border=0 vspace=0 hspace=0>');

  // Write the link text and finish the link and table row.

  if (item.index == treeMenuSelected)
    treeMenuDocument.writeln('<font face="' + treeMenuFont + '" size=' + treeMenuFontSize + '>&nbsp;<span style="background-color:' + treeMenuHiBg + ';color:' + treeMenuHiFg + ';">' + item.text + '</span></font>');
  else
    treeMenuDocument.writeln('<font face="' + treeMenuFont + '" size=' + treeMenuFontSize + '>&nbsp;' + item.text + '</font>');
