...
function reflection() {
    if ( oMyObject != null ) {
        eval( "oMyObject.obj.style." + oMyObject.attribute + "='" + gethtmlCode() + "'");
    }
}

function confirm() {
    reflection();
    parent.palettObj.style.left = -1000;
    parent.palettObj.style.top  = -1000;
    parent.palettObj.style.width = 0;
    parent.palettObj.style.height= 0;
...
function color_getObject( objStr ) {
...
{
	obj1 = color_getObject( objStr1 );
	obj4 = color_getObject( objStr4 );
	value = "#" + selcolor("P1");
...
{
	obj2 = color_getObject( objStr2 );
	obj3 = color_getObject( objStr3 );
...
function clickS2(objStr1,objStr4)
{
	...
	if(event.clientY < 126 || event.clientY > 243 || event.clientX <8 || event.clientX >296)
	{
	  return;
	}
	else{
...
{
	obj5 = color_getObject( objStr5 );
	obj7 = color_getObject( objStr7 );
...
function clickS4(objStr5,objStr7)
{
	obj5 = color_getObject( objStr5 );
	obj7 = color_getObject( objStr7 );
	value= "transparent" ;
	realView_S4(value,"RGBH","viewCol");
    reflection();
}

function realView_S4(value,objStr8,objStr6)
{
	obj8 = color_getObject( objStr8 );
	obj6 = color_getObject( objStr6 );

	obj6.style.backgroundColor = value;

	obj8.htmlCode.value = value;
	obj8.redCol.value = "0";
	obj8.greenCol.value = "0";
	obj8.blueCol.value = "0";
}
