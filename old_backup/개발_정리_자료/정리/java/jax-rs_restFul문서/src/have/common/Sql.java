...
//	        System.out.print("조회 값 : " + _rtV );
	    ...
	    public static int getNumber ( String SQL, Connection conn) {
	    	return Sql.getCount(SQL, conn);
	    }
    /**
    * 오직 한 Row , 한 Column 의 자료를 조회 합니다.
    * @param SQL the String
...
//                 out.println(" 현재 Group의 계산 : li_curarea : " + li_curarea + "<BR>");
 ...
 // ---- Start ------ ◀ 이전 몇 개 Tab ----------------------------------------- //
                 if ( spage - 1 < 1)         {
//                     out.print("[이전 " + li_limit + " 개]&nbsp;");
                     rtValue += "<img src='/images/mytest/btn_prev.gif' style='filter:alpha(opacity=50);opacity:0.5;'>&nbsp;";
//                     out.print("◀ &nbsp;");
                 } else                      {
...
//                             out.print("<a href='" + P_target + "?p_start=1'>◀ 이전&nbsp;</a>");
                             rtValue += "<a href='#' class='page_navi_item' onclick='" + P_jsFunc + "(event,1," + P_Totcount + ");return false;'><img src='/images/mytest/btn_prev.gif'>&nbsp;</a>";
//                             out.print("<a href='#' onclick='PageTab(1," + P_Totcount + ",\"" + P_target + "\");return false;'>◀ &nbsp;</a>");
                     } else {
//                             out.print("<a href='" + P_target + "?p_start=" + Tstart + "'>◀ 이전&nbsp;</a>");
                             rtValue += "<a href='#' class='page_navi_item' onclick='" + P_jsFunc + "(event," + Tstart + "," + P_Totcount + ");return false;'><img src='/images/mytest/btn_prev.gif'>&nbsp;</a>";
//                             out.print("<a href='#' onclick='PageTab(" + Tstart + "," + P_Totcount + ",\"" + P_target + "\");return false;'>◀ &nbsp;</a>");
 ...
 // ---- Start ------ ◀ 한 Tab 씩 이동 ----------------------------------------- //
                 ...
                 if ( li_curpage > 1 ) {
                     ...
                     if  ( li_curarea == 1 ) {
                         if ( li_curpage == 2 ) {
                             rtValue += "<a href='#' class='page_navi_item' onclick='" + P_jsFunc + "(event,1," + P_Totcount + ");return false;'><img src='/images/mytest/btn_prev1.gif'>&nbsp;</a>";
//                             out.print("<a href='#' onclick='PageTab(1," + P_Totcount + ",\"" + P_target + "\");return false;'>◀&nbsp;</a>");
                         } else {
                             rtValue += "<a href='#' class='page_navi_item' onclick='" + P_jsFunc + "(event," + Tstart + "," + P_Totcount + ");return false;'><img src='/images/mytest/btn_prev1.gif'>&nbsp;</a>";
//                             out.print("<a href='#' onclick='PageTab(" + Tstart + "," + P_Totcount + ",\"" + P_target + "\");return false;'>◀&nbsp;</a>");
                         }
                     } else {
                             rtValue += "<a href='#' class='page_navi_item' onclick='" + P_jsFunc + "(event," + Tstart + "," + P_Totcount + ");return false;'><img src='/images/mytest/btn_prev1.gif'>&nbsp;</a>";
//                           out.print("<a href='#' onclick='PageTab(" + Tstart + "," + P_Totcount + ",\"" + P_target + "\");return false;'>◀&nbsp;</a>");
                     ...
                     rtValue += "<img src='/images/mytest/btn_prev1.gif' style='filter:alpha(opacity=50);opacity:0.5;'>&nbsp;";                	 
//                      out.print("◀&nbsp;");
                 }
 // ---- End   ------ ◀ 한 Tab 씩 이동 ---------------------------------------- //
...
//                 out.print(" | ");
         //        out.print("li_totpage : li_totpage / li_curpage  : li_curpage ");
                 if ( li_totpage > li_curpage ) {
                     ...
                     Tstart += li_interval;
                     rtValue += "<a href='#' class='page_navi_item' onclick='" + P_jsFunc + "(event," + Tstart + "," + P_Totcount + ");return false;'>&nbsp;<img src='/images/mytest/btn_next1.gif'></a>";                     
//                   rtValue += "<a href='#' onclick='PageTab(" + Tstart + "," + P_Totcount + ",\"" + P_target + "\");return false;'>&nbsp;▶</a>";
//                   out.print("<a href='#' onclick='PageTab(" + Tstart + "," + P_Totcount + ",\"" + P_target + "\");return false;'>&nbsp;▶</a>");
                 }
                 else{
                     rtValue += "&nbsp;<img src='/images/mytest/btn_next1.gif' style='filter:alpha(opacity=50);opacity:0.5;'>";                	 
//                      out.print("&nbsp;▶");
                 }
 // ---- End   ------ ▶ 한 Tab 씩 이동 ---------------------------------------- //
 ...
 // ---- Start ------ ▶ 다음 몇 개 Tab ---------------------------------------- //
                 if ( epage == li_totpage ) {
//                  out.print("[다음 " + li_limit + " 개]&nbsp;");
                     rtValue += "&nbsp;<img src='/images/mytest/btn_next.gif' style='filter:alpha(opacity=50);opacity:0.5;'>";
//                     out.print("&nbsp;▶");
                 }
                 else {
...
//                      out.print("<a href='" + P_target + "?p_start=" + Tstart + "'>다음&nbsp;▶</a>");
                     rtValue += "<a href='#' class='page_navi_item' onclick='" + P_jsFunc + "(event," + Tstart + "," + P_Totcount + ");return false;'>&nbsp;<img src='/images/mytest/btn_next.gif'></a>";
//                     out.print("<a href='#' onclick='PageTab(" + Tstart + "," + P_Totcount + ",\"" + P_target + "\");return false;'>&nbsp;▶</a>");
                 }
 // ---- End   ------ ▶ 다음 몇 개 Tab ---------------------------------------- //
             }
